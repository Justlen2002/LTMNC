...
class StatusForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'contest_id': forms.TextInput(attrs={'required': True, 'class': 'form-control'}),
            'candidate_id': forms.TextInput(attrs={'required': True, 'class': 'form-control'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            self.fields['contest_id'].initial = self.instance.contest_id
            self.fields['candidate_id'].initial = self.instance.candidate_id
